...
class EvtolCanard : public ModuleParams, public px4::ScheduledWorkItem
{
public:
	EvtolCanard(MW_H7CAN_DEVICE& h7can_device);
	~EvtolCanard();
	...
	static EvtolCanard	*instance() { return _instance; }
...
private:
	...
	static EvtolCanard			*_instance;			///< singleton pointer
