...
FlightTaskMyTask::FlightTaskMyTask() : _collision_prevention(this)
{

}

bool FlightTaskMyTask::updateInitialize()
{
...
bool FlightTaskMyTask::activate(const vehicle_local_position_setpoint_s &last_setpoint)
{
...
void FlightTaskMyTask::_scaleSticks()
{
...
void FlightTaskMyTask::_updateXYlock()
{
...
void FlightTaskMyTask::_updateSetpoints()
{
